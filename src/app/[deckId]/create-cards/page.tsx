...
export default function CreateCards({ params }: any) {
  ...
  /**
   * Saves the uploaded media into firebase storage, then saves its link
   * into the corresponding places inside Firebase
   * 
   * @param[in] media The media(image/video) file to be uploaded
   * @param flashcardId A unique ID for the flashcard generated by Firebase
   * @param[in] side Whether this media is uploaded to the front or back side of the Flashcard
